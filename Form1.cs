namespace TIC_TAC_TOE___A2___Clavecillas
{
    public partial class Form1 : Form
    {
        ...
        private void ForWinners()
        {
            ...
            //VERTICAL
            else if ((btnR1C1.Text == btnR2C1.Text) && (btnR2C1.Text == btnR3C1.Text))
            {
                click = !click;
            ...
            //VERTICAL
            else if ((btnR1C2.Text == btnR2C2.Text) && (btnR2C2.Text == btnR3C2.Text))
            {
                click = !click;
            ...
            //VERTICAL
            else if ((btnR1C3.Text == btnR2C3.Text) && (btnR2C3.Text == btnR3C3.Text))
            {
                click = !click;
            ...
            //DIAGONAL
            else if ((btnR1C1.Text == btnR2C2.Text) && (btnR2C2.Text == btnR3C3.Text))
            {
                click = !click;
            ...
            //DIAGONAL
            else if ((btnR1C3.Text == btnR2C2.Text) && (btnR2C2.Text == btnR3C1.Text))
            {
                click = !click;
